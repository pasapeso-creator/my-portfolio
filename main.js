...
const PARTICLE_COUNT = isMobile ? 25 : (isLowPerformance ? 40 : 80);
const CONNECT_PARTICLES = !isMobile; // Disable connections on mobile
...
// Only initialize particles if canvas exists
if (canvas && ctx) {
...
function animateParticles() {
    ...
    // Connect nearby particles (disabled on mobile)
...
// Only run reveal animations on desktop
if (!isMobile) {
    ...
    // On mobile, just show elements immediately
...
// Fade in on page load (faster on mobile)
